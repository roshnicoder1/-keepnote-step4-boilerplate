...
public class CategoryController {
    ...
    public ResponseEntity<Category> deleteCategory(@PathVariable int id, HttpSession session) throws CategoryNotFoundException {
    ...
    public ResponseEntity<Category> updateCategory(@RequestBody Category category, HttpSession session) throws CategoryNotFoundException {
            if (session.getAttribute("loggedInUserId")==null) {
                return new ResponseEntity<Category>(category, HttpStatus.UNAUTHORIZED);
            }
	 ...
	 */
	@GetMapping("/category")
    public ResponseEntity<List<Category>> getCategoryById(HttpSession session) {
        if (session!=null && session.getAttribute("loggedInUserId") != null) {
